...
![Tìm Amazon SQS](/images/5-Workshop/3.Create-Chat-Queue(AWS-SQS)/images/image13.png)
...
![Chọn Standard Queue](/images/5-Workshop/3.Create-Chat-Queue(AWS-SQS)/images/image14.png)

3. Đặt tên queue là **image-processing-queue**.

![Đặt tên SQS queue](/images/5-Workshop/3.Create-Chat-Queue(AWS-SQS)/images/image15.png)

4. Cấu hình các thông số quan trọng cho queue.

![Cấu hình thông số SQS](/images/5-Workshop/3.Create-Chat-Queue(AWS-SQS)/images/image16.png)

![Kiểm tra cấu hình SQS](/images/5-Workshop/3.Create-Chat-Queue(AWS-SQS)/images/image17.png)
...
![Copy ARN của SQS queue](/images/5-Workshop/3.Create-Chat-Queue(AWS-SQS)/images/image18.png)
